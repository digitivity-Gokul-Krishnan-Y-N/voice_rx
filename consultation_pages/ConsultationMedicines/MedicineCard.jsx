  ...
  return (
    <div className="card border-0 shadow-sm mx-auto" style={{ minWidth: '400px', borderRadius: '20px' }}>
      <div className="card-body p-4">
        {/* Header */}
        <h5 className="card-title mb-4" style={{ color: '#5a809e', fontWeight: '600' }}>
          Medicine {data.id}
        </h5>
        ...
        <div className="row mb-2">
          <div className="col-6">
            <small className="text-secondary d-block">Medicine Name</small>
            <span className="fw-semibold text-dark">{data.name}</span>
          </div>
          <div className="col-6">
            <small className="text-secondary d-block">Dosage</small>
            <span className="fw-semibold text-dark">{data.dosage}</span>
          </div>
        </div>
