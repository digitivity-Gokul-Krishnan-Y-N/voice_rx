...
RESULTS_FILE = Path(__file__).parent / "data" / "live_consultation_result.json"
...
def stop_consultation():
    ...
    try:
        ...
        # Process audio with medical system
        ...
        logger.info(f"✅ Consultation extracted: {json.dumps(result, indent=2)[:500]}")
...
def save_consultation():
    ...
    try:
        ...
        # Save to database via medical system (if implemented)
